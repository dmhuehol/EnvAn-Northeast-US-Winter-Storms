...
freezingLineLog = 1; isohumesLog = 1; ventLog = 1; updraftLog = 0; legLog = 1;
[~,legendEntries,legendText] = iceGrowthDiagram(hd,freezingLineLog,isohumesLog,ventLog,updraftLog,legLog); %Plot the growth diagram
...
for c = 1:length(timeIndex)
    ...
    %radiosondeHeight6 = radiosondeHeight<=12000 & radiosondeHeight>10000;
    %radiosondeHeight7 = radiosondeHeight<=12000 & radiosondeHeight>6000;
    %radiosondeHeight8 = radiosondeHeight<8000 & radiosondeHeight>7000;
    ...
    %shp6 = soundingHumidityPoints(radiosondeHeight6);
    %shp7 = soundingHumidityPoints(radiosondeHeight7);
    %shp8 = soundingHumidityPoints(radiosondeHeight8);
    ...
    %pc6 = scatter(shp6,radiosondeTemp(radiosondeHeight6),'filled','MarkerEdgeColor',[213 94 0]./255,'MarkerFaceColor',[213 94 0]./255);
    %pc7 = scatter(shp7,radiosondeTemp(radiosondeHeight7),'filled','MarkerEdgeColor',[204 121 167]./255,'MarkerFaceColor',[204 121 167]./255);
    %pc8 = scatter(shp8,radiosondeTemp(radiosondeHeight8),'filled','MarkerEdgeColor',[0 0 0],'MarkerFaceColor',[0 0 0]);

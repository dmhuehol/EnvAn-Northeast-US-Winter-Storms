...
TTdTwvZ: Plots temperature, dewpoint, and wetbulb temperature against height given an input time and soundings data structure. Added 2 July 2018.
...
TwindvZ: Plots temperature and wind vs height for an input time. Requires windbarb. windbarb function was written by Laura Tomkins (github @lauratomkins). Updated 2 July 2018 to fix problem where NaN values are plotted as 0kt barbs, and to make aesthetic changes to the figure.
...
inversionCounter: Counts inversions within a sounding structure. Updated 2 July 2018 to use the measured geopotential field preferentially over calculated height, adds documentation, and comments out some defunct sections.
